                ...
                <div>
                  <div class="relative border flex mb-2  md:w-full md:hidden bg-[#1f1f1f] items-stretch rounded-lg">
                    <input
                      onClick={openDialog}
                      type="search"
                      className="relative m-0 block md:w-52 min-w-0  flex-auto rounded bg-[#1f1f1f] bg-clip-padding px-3 py-[0.25rem] text-xs font-normal leading-[1.6] text-neutral-700 outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:text-neutral-700 focus:shadow-[inset_0_0_0_1px_rgb(59,113,202)] focus:outline-none dark:border-neutral-600 dark:focus:border-primary"
