...
export default async (req, res) => {
  try {
    ...
    const apiUrl = `https://api.arbiscan.io/api?module=account&action=txlist&address=${walletAddress}&startblock=0&endblock=latest&page=${page}&offset=${offset}&sort=${sort}&apikey=YourApiKeyToken`;
